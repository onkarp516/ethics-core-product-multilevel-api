...
import in.truethics.ethics.ethicsapiv10.exception.EthicsException;
...
public class TranxPurInvoiceService {
            ...
            if (mPurchaseTranx != null) {
                ...
                if (paramMap.containsKey("paymentMode")) {
                    ...
                    if (paymentMode.equalsIgnoreCase("cash")) {
                        createPaymentInvoice(mPurchaseTranx, users, paymentMode, mPurchaseTranx.getTotalAmount(), 0.0, paymentMode, "create");
    ...
    private void createPaymentInvoice(TranxPurInvoice newInvoice, Users users, String paymentType, Double totalPaidAmt, Double returnAmt, String paymentMode, String key) {
        ...
        if (newInvoice.getBranch() != null) tranxPaymentMaster.setBranch(newInvoice.getBranch());
    ...
    private void insertIntoPaymentPerticualrs(TranxPaymentMaster newTranxPaymentMaster, LedgerMaster ledgerMaster, String type, double amount, String key, String payMode, TransactionTypeMaster tranxType, TranxPurInvoice newInvoice) {
        ...
        ledgerCommonPostings.callToPostingsTranxCode(amount, ledgerMaster, tranxType, ledgerMaster.getAssociateGroups(), newTranxPaymentMaster.getFiscalYear(), newTranxPaymentMaster.getBranch(), newTranxPaymentMaster.getOutlet(), newTranxPaymentMaster.getTranscationDate(), newTranxPaymentMaster.getId(), newTranxPaymentMaster.getPaymentNo(), ledgerType, true, tranxType.getTransactionCode(), "Insert", newTranxPaymentMaster.getTranxCode());
    }
...
//            ledgerCommonPostings.callToPostings(mPurchaseTranx.getTcsAmt(), mLedger, tranxType, mLedger.getAssociateGroups(), mPurchaseTranx.getFiscalYear(), mPurchaseTranx.getBranch(), mPurchaseTranx.getOutlet(), mPurchaseTranx.getInvoiceDate(), mPurchaseTranx.getId(), mPurchaseTranx.getVendorInvoiceNo(), crdr, true, tranxType.getTransactionCode(), operation);
...
//        generateTransactions.insertIntoTranxsDetails(mPurchaseTranx,tranxType);
    ...
    public void insertIntoTranxDetailPD(TranxPurReturnInvoice mPurchaseTranx, TransactionTypeMaster tranxType, String crdrTyep, String operation) {
        try {
            if (mPurchaseTranx.getPurchaseDiscountLedger() != null) {
                /**** New Postings Logic *****/
                ledgerCommonPostings.callToPostings(mPurchaseTranx.getTotalPurchaseDiscountAmt(), mPurchaseTranx.getPurchaseDiscountLedger(), tranxType, mPurchaseTranx.getPurchaseDiscountLedger().getAssociateGroups(), mPurchaseTranx.getFiscalYear(), mPurchaseTranx.getBranch(), mPurchaseTranx.getOutlet(), mPurchaseTranx.getPurReturnDate(), mPurchaseTranx.getId(), mPurchaseTranx.getPurRtnNo(), crdrTyep, true, "Purchase Return", operation);
    ...
    public void insertIntoTranxDetailSC(TranxPurInvoice mPurchaseTranx, TransactionTypeMaster tranxType, String type, String operation) {
        try {
            /**** New Postings Logic *****/
            Double amt = 0.0;
            amt = mPurchaseTranx.getTotalAmount();
//            ledgerCommonPostings.callToPostings(amt, mPurchaseTranx.getSundryCreditors(), tranxType, mPurchaseTranx.getSundryCreditors().getAssociateGroups(), mPurchaseTranx.getFiscalYear(), mPurchaseTranx.getBranch(), mPurchaseTranx.getOutlet(), mPurchaseTranx.getInvoiceDate(), mPurchaseTranx.getId(), mPurchaseTranx.getVendorInvoiceNo(), type, true, tranxType.getTransactionCode(), operation);
    ...
    public void insertIntoTranxDetailPA(TranxPurInvoice mPurchaseTranx, TransactionTypeMaster tranxType, String type, String operation) {
        try {
            /**** New Postings Logic *****/
//            ledgerCommonPostings.callToPostings(mPurchaseTranx.getTaxableAmount(), mPurchaseTranx.getPurchaseAccountLedger(), tranxType, mPurchaseTranx.getPurchaseAccountLedger().getAssociateGroups(), mPurchaseTranx.getFiscalYear(), mPurchaseTranx.getBranch(), mPurchaseTranx.getOutlet(), mPurchaseTranx.getInvoiceDate(), mPurchaseTranx.getId(), mPurchaseTranx.getVendorInvoiceNo(), type, true, tranxType.getTransactionCode(), operation);
...
//                ledgerCommonPostings.callToPostings(mPurchaseTranx.getRoundOff(), mPurchaseTranx.getPurchaseRoundOff(), tranxType, mPurchaseTranx.getPurchaseRoundOff().getAssociateGroups(), mPurchaseTranx.getFiscalYear(), mPurchaseTranx.getBranch(), mPurchaseTranx.getOutlet(), mPurchaseTranx.getInvoiceDate(), mPurchaseTranx.getId(), mPurchaseTranx.getVendorInvoiceNo(), "DR", true, tranxType.getTransactionCode(), "Insert");
                ledgerCommonPostings.callToPostingsTranxCode(mPurchaseTranx.getRoundOff(), mPurchaseTranx.getPurchaseRoundOff(), tranxType, mPurchaseTranx.getPurchaseRoundOff().getAssociateGroups(), mPurchaseTranx.getFiscalYear(), mPurchaseTranx.getBranch(), mPurchaseTranx.getOutlet(), mPurchaseTranx.getInvoiceDate(), mPurchaseTranx.getId(), mPurchaseTranx.getVendorInvoiceNo(), "DR", true, tranxType.getTransactionCode(), "Insert", mPurchaseTranx.getTranxCode());
            } else if (mPurchaseTranx.getRoundOff() < 0) {
...
//            ledgerCommonPostings.callToPostings(mDuties.getAmount(), mDuties.getDutiesTaxes(), tranxType, mDuties.getDutiesTaxes().getAssociateGroups(), mPurchaseTranx.getFiscalYear(), mPurchaseTranx.getBranch(), mPurchaseTranx.getOutlet(), mPurchaseTranx.getInvoiceDate(), mPurchaseTranx.getId(), mPurchaseTranx.getVendorInvoiceNo(), type, true, tranxType.getTransactionCode(), operation);
    ...
    public void insertFromAdditionalCharges(TranxPurInvoiceAdditionalCharges mAdditinoalCharges, TranxPurInvoice mPurchaseTranx, TransactionTypeMaster tranxType, String type, String operation) {
        try {
            /**** New Postings Logic *****/
//            ledgerCommonPostings.callToPostings(mAdditinoalCharges.getAmount(), mAdditinoalCharges.getAdditionalCharges(), tranxType, mAdditinoalCharges.getAdditionalCharges().getAssociateGroups(), mPurchaseTranx.getFiscalYear(), mPurchaseTranx.getBranch(), mPurchaseTranx.getOutlet(), mPurchaseTranx.getInvoiceDate(), mPurchaseTranx.getId(), mPurchaseTranx.getVendorInvoiceNo(), type, true, tranxType.getTransactionCode(), operation);
    ...
    @Transactional(rollbackFor = {EthicsException.class})
    public TranxPurInvoice saveIntoPurchaseInvoice(MultipartHttpServletRequest request) throws EthicsException {
        ...
        try {
            ...
            if (paramMap.containsKey("invoice_date")) {
                ...
                date = LocalDate.parse(request.getParameter("invoice_date"));
            ...
            System.out.println("Error in DataIntegrityViolationException 1");
            StringWriter sw = new StringWriter();
            e.printStackTrace(new PrintWriter(sw));
            String exceptionAsString = sw.toString();
            purInvoiceLogger.error("Error in saveIntoPurchaseInvoice  DataIntegrityViolationException :" + exceptionAsString);
        } catch (Exception e1) {
            System.out.println("Error in saveIntoPurchaseInvoice 2");
            StringWriter sw = new StringWriter();
            e1.printStackTrace(new PrintWriter(sw));
            String exceptionAsString = sw.toString();
            purInvoiceLogger.error("Error in saveIntoPurchaseInvoice :" + exceptionAsString);
//            throw new EthicsException(e1.getMessage());
        }
    ...
    public void saveIntoPurchaseInvoiceDetails(JsonArray array, TranxPurInvoice mPurchaseTranx,
                                               ...
                                               TransactionTypeMaster tranxType, String referenceObject) throws EthicsException {
...
//                invoiceUnits.setDiscountAmount(object.get("dis_amt").getAsDouble());
                ...
                if (object.has("dis_amt")) {
                    invoiceUnits.setDiscountAmount(object.get("dis_amt").getAsDouble());
                } else {
                    invoiceUnits.setDiscountAmount(0.0);
                }

                if (object.has("dis_per")) {
                ...
                try {
                    if (object.get("is_batch").getAsBoolean()) {
                        ...
                        if (object.get("b_details_id").getAsLong() == 0) {
                            ...
                            if (object.has("costing") && !object.get("costing").isJsonNull()) {
                                costing = object.get("costing").getAsDouble();
                                mproductBatchNo.setCosting(costing);
                            } else mproductBatchNo.setCosting(costing);
                            if (object.has("costing_with_tax") && !object.get("costing_with_tax").isJsonNull()) {
                                costing_with_tax = object.get("costing_with_tax").getAsDouble();
                                mproductBatchNo.setCostingWithTax(costing_with_tax);
                            } else mproductBatchNo.setCostingWithTax(costing_with_tax);
                            ...
                            if (object.has("b_sale_rate") && !object.get("b_sale_rate").getAsString().equalsIgnoreCase(""))
                            ...
                            if (object.has("margin_per") && !object.get("margin_per").getAsString().equalsIgnoreCase(""))
                    ...
                    if (mUnitPackaging != null) {
                        if (mUnitPackaging.getPurchaseRate() != 0 && prrate != mUnitPackaging.getPurchaseRate()) {
                            ...
                            mUnitPackaging.setCostingWithTax(costing_with_tax);
                            productUnitRepository.save(mUnitPackaging);
                        }
                    }
                    /******* Inventory Postings for Serial Number  ******/
                    ...
                    if (jsonArray != null && jsonArray.size() > 0) {
                        ...
                        for (JsonElement jsonElement : jsonArray) {
                            ...
                            productSerialNumber.setUnits(units);
                            productSerialNumber.setPurchaseInvoiceId(mPurchaseTranx.getId());

                            if (object.has("sales_rate") && !object.get("sales_rate").getAsString().equalsIgnoreCase(""))
                                productSerialNumber.setSalesRate(object.get("sales_rate").getAsDouble());
                            if (object.has("costing") && !object.get("costing").isJsonNull())
                                productSerialNumber.setCosting(object.get("costing").getAsDouble());
                            if (object.has("costing_with_tax") && !object.get("costing_with_tax").isJsonNull())
                                productSerialNumber.setCostingWithTax(object.get("costing_with_tax").getAsDouble());
                            if (object.has("b_rate") && !object.get("b_rate").getAsString().equalsIgnoreCase(""))
                                productSerialNumber.setMrp(object.get("b_rate").getAsDouble());
                            if (object.has("rate_a") && !object.get("rate_a").getAsString().equalsIgnoreCase(""))
                                productSerialNumber.setSalesRateA(object.get("rate_a").getAsDouble());
                            if (object.has("rate_b") && !object.get("rate_b").getAsString().equalsIgnoreCase(""))
                                productSerialNumber.setSalesRateB(object.get("rate_b").getAsDouble());
                            if (object.has("rate_c") && !object.get("rate_c").getAsString().equalsIgnoreCase(""))
                                productSerialNumber.setSalesRateC(object.get("rate_c").getAsDouble());
                            if (object.has("margin_per") && !object.get("margin_per").getAsString().equalsIgnoreCase(""))
                                productSerialNumber.setMargin(object.get("margin_per").getAsDouble());
                            if (object.has("companybarcode") && !object.get("companybarcode").getAsString().equalsIgnoreCase(""))
                                productSerialNumber.setBarcode(object.get("companybarcode").getAsString());
                            ...
                            if (mProduct.getIsInventory() && !referenceType.equalsIgnoreCase("PRSCHN")) {
                                inventoryCommonPostings.callToInventoryPostings("CR",
                                        ...
                                        tranxQty + free_qty, branch, outlet, mProduct, tranxType,
                        ...
                        /**** Inventory Postings for Batch *****/
                        if (mProduct.getIsInventory() && !referenceType.equalsIgnoreCase("PRSCHN")) {
                            /***** new architecture of Inventory Postings *****/
                            if (object.get("inventoryId").getAsLong() > 0) {
                                inventoryCommonPostings.callToUpdateInventoryOfProduct(object.get("inventoryId").getAsLong(), mPurchaseTranx.getId(), tranxQty);
                            }
 ...
 **/
                                closingUtility.stockPosting(outlet, branch, mPurchaseTranx.getFiscalYear().getId(), batchId,
                                        mProduct, tranxType.getId(), mPurchaseTranx.getInvoiceDate(), tranxQty, free_qty,
                                        mPurchaseTranx.getId(), units.getId(), levelAId, levelBId, levelCId, productBatchNo,
                                        mPurchaseTranx.getTranxCode(), userId, "IN");
                    ...
                    System.out.println("Error in saveIntoPurchaseInvoiceDetails 3  ");
                    StringWriter sw = new StringWriter();
                    e.printStackTrace(new PrintWriter(sw));
                    String exceptionAsString = sw.toString();
                    purInvoiceLogger.error("Error in saveIntoPurchaseInvoiceDetails 3 :" + exceptionAsString);
                    throw e;
                }
...
//                barcode = barcodeRepository.findByProductIdAndOutletIdAndStatus(mProduct.getId(), outlet.getId(), true);
            ...
            System.out.println("Error in saveIntoPurchaseInvoiceDetails 4");
            StringWriter sw = new StringWriter();
            e.printStackTrace(new PrintWriter(sw));
            String exceptionAsString = sw.toString();
            purInvoiceLogger.error("Error in saveIntoPurchaseInvoiceDetails 4:" + exceptionAsString);
            throw new EthicsException(e.getMessage());
        }
    }
...
//        String endYear = generateFiscalYear.getEndYear();
    ...
    public Object purchaseList(@RequestBody Map<String, String> request, HttpServletRequest req) {
        ...
        String endDate = "";
        if (request.containsKey("endDate")) endDate = request.get("endDate");
        if (endDate.isEmpty()) endDate = LocalDate.now().toString();
    ...
    private PurInvoiceDTO convertToDTDTO(TranxPurInvoice purInvoice) {
        ...
        purInvoiceDTO.setNarration(purInvoice.getNarration());
        ...
        purInvoiceDTO.setIgst(purInvoice.getTotaligst());
        purInvoiceDTO.setCgst(purInvoice.getTotalcgst());
        purInvoiceDTO.setSgst(purInvoice.getTotalsgst());
        String idList[];
        String referenceNo = "";
        purInvoiceDTO.setReferenceType(purInvoice.getReference());
        if (purInvoice.getReference() != null) {
            if (purInvoice.getReference().equalsIgnoreCase("PRSORD")) {
            ...
            } else if (purInvoice.getReference().equalsIgnoreCase("PRSCHN")) {
//                idList = purInvoice.getPoId() != null ? purInvoice.getPoId().split(",") : ;
                if (purInvoice.getPoId() != null) {
    ...
    public JsonObject getPurchaseInvoiceByIdNew(HttpServletRequest request) {
        ...
        try {
            ...
            for (TranxPurInvoiceDetailsUnits mUnits : unitsArray) {
                ...
                selectedProduct.addProperty("packing", mUnits.getProduct().getPackingMaster() != null ? mUnits.getProduct().getPackingMaster().getPackName() : "");
              ...
              /*  if (mUnits.getReturnQty() != null) {
                    returnqty = mUnits.getReturnQty();
                }
                if ((mUnits.getQty() - returnqty) != 0)
                    unitsJsonObjects.addProperty("qty", mUnits.getQty() - returnqty);
                else {
                    unitsJsonObjects.addProperty("qty", mUnits.getQty());
                }*/
//                double returnableQty = tranxPurReturnDetailsUnitRepository.getReturnableQty
                unitsJsonObjects.addProperty("qty", mUnits.getQty());
                ...
                if (mUnits.getProductBatchNo() != null) {
                    ...
                    unitsJsonObjects.addProperty("min_discount", mUnits.getProductBatchNo().getMinDiscount() != null ? mUnits.getProductBatchNo().getMinDiscount().toString() : "");
                    unitsJsonObjects.addProperty("max_discount", mUnits.getProductBatchNo().getMaxDiscount() != null ? mUnits.getProductBatchNo().getMaxDiscount().toString() : "");
                    ...
                    unitsJsonObjects.addProperty("margin_per", mUnits.getProductBatchNo().getMinMargin() != null ? mUnits.getProductBatchNo().getMinMargin().toString() : "");
                    ...
                    unitsJsonObjects.addProperty("companybarcode", "");
                }

                if (mUnits.getProduct().getIsSerialNumber() == true) {
                    TranxPurchaseInvoiceProductSrNumber tranxSrno = serialNumberRepository.findTop1ByPurchaseInvoiceIdAndStatus(mUnits.getPurchaseTransaction().getId(), true);
                    if (tranxSrno != null) {
                        unitsJsonObjects.addProperty("min_rate_a", tranxSrno.getSalesRateA());
                        unitsJsonObjects.addProperty("min_rate_b", tranxSrno.getSalesRateB());
                        unitsJsonObjects.addProperty("min_rate_c", tranxSrno.getSalesRateC());
                        unitsJsonObjects.addProperty("mrp", tranxSrno.getMrp());
                        unitsJsonObjects.addProperty("sales_rate", tranxSrno.getSalesRate());
                        unitsJsonObjects.addProperty("margin_per", tranxSrno.getMargin());
                        unitsJsonObjects.addProperty("b_rate", tranxSrno.getMrp());
                        unitsJsonObjects.addProperty("costing", tranxSrno.getCosting());
                        unitsJsonObjects.addProperty("costingWithTax", tranxSrno.getCostingWithTax());
                        unitsJsonObjects.addProperty("companybarcode", tranxSrno.getBarcode());
                    }
                }
                /**** Serial Number ****/
                ...
                unitsJsonObjects.addProperty("is_serial", mUnits.getProduct().getIsSerialNumber() != null ? mUnits.getProduct().getIsSerialNumber() : false);
    ...
    private ResponseMessage saveIntoPurchaseInvoiceEdit(MultipartHttpServletRequest request, String key) {
        ...
        Users users = jwtRequestFilter.getUserDataFromToken(request.getHeader("Authorization").substring(7));
        tranxType = tranxRepository.findByTransactionCodeIgnoreCase("PRS");
        invoiceTranx = tranxPurInvoiceRepository.findByIdAndOutletIdAndStatus(Long.parseLong(request.getParameter("id")), users.getOutlet().getId(), true);
        //LocalDate purDate = invoiceTranx.getInvoiceDate();
        ...
        if (invoiceTranx != null) {
            ...
            Boolean taxFlag;
            LocalDate newInvoiceDate = DateConvertUtil.convertStringToLocalDate(request.getParameter("invoice_date"));
            Date strDt = DateConvertUtil.convertStringToDate(request.getParameter("invoice_date"));
            if (newInvoiceDate.isEqual(DateConvertUtil.convertDateToLocalDate(invoiceTranx.getInvoiceDate()))) {
            ...
            /* fiscal year mapping */
            FiscalYear fiscalYear = generateFiscalYear.getFiscalYear(newInvoiceDate);
            if (fiscalYear != null) {
                invoiceTranx.setFinancialYear(fiscalYear.getFiscalYear());
            }
            /* End of fiscal year mapping */
            ...
            if (purchaseAccount.getId() != null && invoiceTranx.getId() != null && tranxType.getId() != null) {
                ...
                if (isContains) {
                    ...
                    ledgerCommonPostings.callToPostings(
                            Double.parseDouble(request.getParameter("taxable_amount")),
                            purchaseAccount, tranxType, purchaseAccount.getAssociateGroups(),
                            fiscalYear, invoiceTranx.getBranch(),
                            invoiceTranx.getOutlet(), strDt,
                            invoiceTranx.getId(), invoiceTranx.getVendorInvoiceNo(), "DR", true, "Purchase Invoice", "Insert");
                }
            }
...
//                    LocalDate pur_date = DateConvertUtil.convertDateToLocalDate(invoiceTranx.getInvoiceDate());

                    saveIntoPurchaseInvoiceDetailsEdit(array, mPurchaseTranx, users.getBranch() != null ?
                            users.getBranch() : null, users.getOutlet(), users.getId(), rowsDeleted, tranxType, invoiceTranx.getInvoiceDate());
    ...
    public void saveIntoPurchaseInvoiceDetailsEdit(JsonArray array, TranxPurInvoice mPurchaseTranx, Branch branch,
                                                   Outlet outlet, Long userId, String rowsDeleted,
                ...
                if (jsonArray != null && jsonArray.size() > 0) {
                    ...
                    for (JsonElement jsonElement : jsonArray) {
                        ...
                        if (detailsId == 0) {
                            ...
                            productSerialNumber1.setPurchaseInvoiceId(mPurchaseTranx.getId());
                            if (object.has("sales_rate") && !object.get("sales_rate").getAsString().equalsIgnoreCase(""))
                                productSerialNumber1.setSalesRate(object.get("sales_rate").getAsDouble());
                            if (object.has("costing") && !object.get("costing").isJsonNull())
                                productSerialNumber1.setCosting(object.get("costing").getAsDouble());
                            if (object.has("costing_with_tax") && !object.get("costing_with_tax").isJsonNull())
                                productSerialNumber1.setCostingWithTax(object.get("costing_with_tax").getAsDouble());
                            if (object.has("b_rate") && !object.get("b_rate").getAsString().equalsIgnoreCase(""))
                                productSerialNumber1.setMrp(object.get("b_rate").getAsDouble());
                            if (object.has("rate_a") && !object.get("rate_a").getAsString().equalsIgnoreCase(""))
                                productSerialNumber1.setSalesRateA(object.get("rate_a").getAsDouble());
                            if (object.has("rate_b") && !object.get("rate_b").getAsString().equalsIgnoreCase(""))
                                productSerialNumber1.setSalesRateB(object.get("rate_b").getAsDouble());
                            if (object.has("rate_c") && !object.get("rate_c").getAsString().equalsIgnoreCase(""))
                                productSerialNumber1.setSalesRateC(object.get("rate_c").getAsDouble());
                            if (object.has("margin_per") && !object.get("margin_per").getAsString().equalsIgnoreCase(""))
                                productSerialNumber1.setMargin(object.get("margin_per").getAsDouble());
                            if (object.has("companybarcode") && !object.get("companybarcode").getAsString().equalsIgnoreCase(""))
                                productSerialNumber1.setBarcode(object.get("companybarcode").getAsString());
                    ...
                    if (mProduct.getIsInventory()) {
                        ...
                        if (details_id != 0) {
                             ...
                             * Case 1: Modify QTY
                             **/
                            LocalDate mp_invoice_date = DateConvertUtil.convertDateToLocalDate(mPurchaseTranx.getInvoiceDate());
                            ...
                            System.out.println("invoice Date"+mPurchaseTranx.getInvoiceDate());
                            System.out.println("tranx De"+productRow.getTranxDate());
                            System.out.println("qty "+ object.get("qty").getAsDouble());
                            System.out.println("Tranx qty "+  tranxQty.doubleValue());
                        ...
                        if (deletedRowsId.has("del_id")) {
                            ...
                            if (mDeletedInvoices != null) {
                                ...
                                try {
                                    ...
                                    inventoryCommonPostings.callToInventoryPostings("DR", mDeletedInvoices.getPurchaseTransaction().getInvoiceDate(), mDeletedInvoices.getPurchaseTransaction().getId(), mDeletedInvoices.getQty() + mDeletedInvoices.getFreeQty(), branch, outlet, mDeletedInvoices.getProduct(), tranxType, mDeletedInvoices.getLevelA(), mDeletedInvoices.getLevelB(), mDeletedInvoices.getLevelC(), mDeletedInvoices.getUnits(), mDeletedInvoices.getProductBatchNo(), mDeletedInvoices.getProductBatchNo() != null ? mDeletedInvoices.getProductBatchNo().getBatchNo() : null, mDeletedInvoices.getPurchaseTransaction().getFiscalYear(), null);
                                    /***** End of new architecture of Inventory Postings *****/
...
//                    int inputGst = (int) cgstObject.get("gst").getAsDouble();
    ...
    public JsonObject purchaseDelete(HttpServletRequest request) {
        ...
        try {
            ...
            /**** make status=0 against the purchase product details units *****/
            List<TranxPurInvoiceDetailsUnits> detailsUnits = tranxPurInvoiceUnitsRepository.findByPurchaseTransactionIdAndStatus(invoiceTranx.getId(), true);
            for (TranxPurInvoiceDetailsUnits mDetails : detailsUnits) {
                mDetails.setStatus(false);
                tranxPurInvoiceUnitsRepository.save(mDetails);
            }
            ...
            if (invoiceTranx != null) {
                ...
                /**** make status=0 to all ledgers of respective purchase return id, due to this we wont get
                 details of deleted invoice when we want to get the details of respective ledger ****/
                ...
                for (TranxPurReturnInvoice returnInvoice : purReturnList) {
                    ...
                    for (TranxPurReturnDetailsUnits mUnitObjects : returnList) {
                        /***** new architecture of Inventory Postings *****/
                        inventoryCommonPostings.callToInventoryPostings("CR", returnInvoice.getPurReturnDate(), returnInvoice.getId(), mUnitObjects.getQty(), returnInvoice.getBranch(), returnInvoice.getOutlet(), mUnitObjects.getProduct(), returnTranx, null, null, null, mUnitObjects.getUnits(), mUnitObjects.getProductBatchNo(), mUnitObjects.getProductBatchNo() != null ? mUnitObjects.getProductBatchNo().getBatchNo() : null, returnInvoice.getFiscalYear(), null);
                        /***** End of new architecture of Inventory Postings *****/
                    }
                }
    ...
    public Object validatePurchaseInvoices(HttpServletRequest request) {
        ...
        if (users.getBranch() != null) {
            purInvoice = tranxPurInvoiceRepository.findByOutletIdAndBranchIdAndSundryCreditorsIdAndStatusAndVendorInvoiceNoIgnoreCase(users.getOutlet().getId(), users.getBranch().getId(), sundryCreditorId, true, request.getParameter("bill_no"));
        } else {
            purInvoice = tranxPurInvoiceRepository.findByOutletIdAndSundryCreditorsIdAndStatusAndVendorInvoiceNoIgnoreCaseAndBranchIsNull(users.getOutlet().getId(), sundryCreditorId, true, request.getParameter("bill_no"));
        }
        if (purInvoice != null) {
    ...
    public JsonObject purchasePrintInvoice(HttpServletRequest request) {
        ...
        try {
            ...
            if (purInvoice != null) {
                ...
                invoiceObject.addProperty("invoice_dt", DateConvertUtil.convertDateToLocalDate(purInvoice.getInvoiceDate()).toString());
