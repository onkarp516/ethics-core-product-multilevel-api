...
//                salesQuotationDutiesTaxes = salesOrderTransaction.getSalesQuotationDutiesTaxes();
    ...
    public JsonObject AllsaleQuotationList(HttpServletRequest request) {
...
//            }
    ...
    private SalesOrderDTO convertToDTDTO(TranxSalesOrder tranxSalesOrder) {
        ...
        salesOrderDTO.setId(tranxSalesOrder.getId());
        salesOrderDTO.setBill_no(tranxSalesOrder.getSo_bill_no());
        salesOrderDTO.setBill_date(DateConvertUtil.convertDateToLocalDate(tranxSalesOrder.getBillDate()).toString());
        salesOrderDTO.setTotal_amount(tranxSalesOrder.getTotalAmount());

        salesOrderDTO.setTotal_base_amount(tranxSalesOrder.getTotalBaseAmount());
        salesOrderDTO.setSundry_debtors_name(tranxSalesOrder.getSundryDebtors().getLedgerName());
        salesOrderDTO.setSundry_debtors_id(tranxSalesOrder.getSundryDebtors().getId());
        salesOrderDTO.setSales_order_status(tranxSalesOrder.getTransactionStatus().getStatusName());
        salesOrderDTO.setSale_account_name(tranxSalesOrder.getSalesAccountLedger().getLedgerName());
        salesOrderDTO.setNarration(tranxSalesOrder.getNarration());
        salesOrderDTO.setTax_amt(tranxSalesOrder.getTotalTax() != null ? tranxSalesOrder.getTotalTax() : 0.0);
        salesOrderDTO.setTaxable_amt(tranxSalesOrder.getTaxableAmount());
        salesOrderDTO.setTranxCode(tranxSalesOrder.getTranxCode());
    ...
    public JsonObject getSaleOrdersWithIds(HttpServletRequest request) {
        ...
        for (JsonElement mList : jsonArray) {
            ...
            for (TranxSalesOrderDetailsUnits mUnits : unitsArray) {
                ...
                invoiceData.addProperty("reference", mUnits.getSalesOrder().getReference());
                ...
                invoiceData.addProperty("narration", mUnits.getSalesOrder().getNarration());
