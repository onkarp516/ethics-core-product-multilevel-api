...
import in.truethics.ethics.ethicsapiv10.repository.ledgerdetails_repository.LedgerOpeningBalanceRepository;
...
//        Long count = tranxJournalMasterRepository.findLastRecord(users.getOutlet().getId());
    ...
    public JsonObject createJournal(HttpServletRequest request) {
        ...
        journalMaster.setTransactionDate(DateConvertUtil.convertStringToDate(request.getParameter("transaction_dt")));
                    ...
                    if (billList != null && billList.size() > 0) {
                        for (int j = 0; j < billList.size(); j++) {
                           ...
                           /* DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
                            ...
                            System.out.println("==>>>> "+jsonBill.get("invoice_date").getAsString());*/
//                            LocalDate dtt = LocalDate.parse(jsonBill.get("invoice_date").toString());
//                            System.out.println("--=-=-=>><> "+dtt);

                            Date dt = DateConvertUtil.convertStringToDate(jsonBill.get("invoice_date").getAsString());
                            tranxBillDetails.setTransactionDate(DateConvertUtil.convertDateToLocalDate(dt));
    ...
    private void createCreditNote(TranxJournalMaster tranxJournalMaster, double total_amt, LedgerMaster ledgerMaster,
        ...
        tranxCreditNoteMaster.setTranscationDate(tranxJournalMaster.getTransactionDate());
    ...
    private void createDebitNote(TranxJournalMaster tranxJournalMaster, double total_amt, LedgerMaster ledgerMaster,
        ...
        tranxDebitNoteNewReference.setTranscationDate(tranxJournalMaster.getTransactionDate());
        try {
    ...
    private void insertIntoPostings(TranxJournalDetails mjournal, double total_amt, String crdrType,
        ...
        try {
            ...
            ledgerCommonPostings.callToPostings(total_amt, mjournal.getLedgerMaster(), tranxType,
                    ...
                    mjournal.getBranch(), mjournal.getOutlet(), mjournal.getTranxJournalMaster().getTransactionDate(),
    ...
    public void saveIntoDayBook(TranxJournalDetails mjournal) {
        ...
        LocalDate trDt = DateConvertUtil.convertDateToLocalDate(mjournal.getTranxJournalMaster().getTransactionDate());
    ...
    public JsonObject journalListbyOutlet(HttpServletRequest request) {
        ...
        for (TranxJournalMaster vouchers : journal) {
            ...
            response.addProperty("transaction_dt", vouchers.getTransactionDate().toString());
...
//                query += " AND transaction_date BETWEEN '" + startDate +"' AND '" + endDate + "'";
    ...
    private JournalDTO convertToDTDTO(TranxJournalMaster tranxJournalMaster) {
        ...
        journalDTO.setTransaction_dt(tranxJournalMaster.getTransactionDate().toString());
...
*/
            ...
            if (mjournal.getType().equalsIgnoreCase("dr")) {
                if (detailsId != 0) {
                    ...
                    if (mLedger != null) {
                        ...
                        mLedger.setTransactionDate(mjournal.getTranxJournalMaster().getTransactionDate());
    ...
    public JsonObject getjournalById(HttpServletRequest request) {
        ...
        try {
            ...
            finalResult.addProperty("tranx_date", journalMaster.getTransactionDate().toString());
