...
public class DebitNoteReportService {
    ...
    public InputStream exportExcelDebitNoteReport(Map<String, String> jsonRequest, HttpServletRequest request) {
        Users users = jwtRequestFilter.getUserDataFromToken(request.getHeader("Authorization").substring(7));
        try {
            ...
            if (productBatchNos.size() > 0) {
                try (Workbook workbook = new XSSFWorkbook()) {
                    ...
                    Sheet sheet = workbook.createSheet(" DebitNoteReport");
...
//                            System.out.println("data ------> " + s);
    ...
    public InputStream exportExcelDebitNoteReport2(Map<String, String> jsonRequest, HttpServletRequest request) {
        Users users = jwtRequestFilter.getUserDataFromToken(request.getHeader("Authorization").substring(7));
        try {
//            Boolean mfgShow = Boolean.valueOf(request.getParameter("mfgShow"));
            String JsonToStr = jsonRequest.get("list");
