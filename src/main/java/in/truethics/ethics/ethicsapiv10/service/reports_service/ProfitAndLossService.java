...
//        return res;
//    }
public Object getProfitAndLossAc(HttpServletRequest request) {     //New API
    JsonArray result = new JsonArray();
    JsonObject res = new JsonObject();
    LedgerTransactionDetails ledgerTransactionDetails = null;
    Long ledgeIdpc = 0L, ledgeIdde = 0L, ledgeIdie = 0L, ledgeIdsa = 0L, ledgeIdii = 0L, ledgeIdidc = 0L;
...
//        return res;
//    }
public Object getProfitAndLossAcStep1(HttpServletRequest request) {     //New API
    JsonArray result = new JsonArray();
    JsonObject res = new JsonObject();
    List<Object[]> list = new ArrayList<>();
    List<LedgerTransactionDetails> mList = new ArrayList<>();
...
//            Long principle_id = Long.valueOf(request.getParameter("ledger_master_id"));
//            Users users = jwtRequestFilter.getUserDataFromToken(request.getHeader("Authorization").substring(7));
...
//                if (users.getBranch() != null) {
//                    opening_bal = ledgerMasterRepository.findByIdAndOutletIdAndBranchIdAndStatuslm(users.getOutlet().getId(), users.getBranch().getId(), true, principle_id);
//                } else {
//                    opening_bal = ledgerMasterRepository.findByIdAndOutletIdAndStatuslm(users.getOutlet().getId(), true, principle_id);
//                }
//            }
...
//    }
    ...
    public Object getProfitAndLossAcStep2(HttpServletRequest request) {   //New API
        JsonObject res = new JsonObject();
        Long id = 0L, ledger_master_id = 0L;
        Double total_month_sum = 0.0;
        Double credit_total = 0.0;
...
//public Object getProfitAndLossAcStep3(HttpServletRequest request) {   //New API
//    JsonArray result = new JsonArray();
//    JsonObject res = new JsonObject();
////        List<LedgerTransactionPostings> mlist = new ArrayList<>();
