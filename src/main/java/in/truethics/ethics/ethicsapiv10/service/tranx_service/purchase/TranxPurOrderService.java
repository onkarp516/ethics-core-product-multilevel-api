...
public class TranxPurOrderService {
    ...
    public TranxPurOrder saveIntoPOInvoice(HttpServletRequest request) {
        ...
        LocalDate mTranxDate = LocalDate.parse(request.getParameter("transaction_date"));
        ...
        tranxPurOrder.setTotalPurchaseDiscountAmt(Double.parseDouble(request.getParameter("total_purchase_discount_amt")));
        try {
    ...
    private PurOrderDTO convertToDTDTO(TranxPurOrder purOrder) {
        ...
        purOrderDTO.setTax_amt(purOrder.getTotalTax());
    ...
    public JsonObject getPOInvoiceWithIds(HttpServletRequest request) {
        ...
        for (JsonElement mList : jsonArray) {
            ...
            for (TranxPurOrderDetailsUnits mUnits : unitsArray) {
                ...
                invoiceData.addProperty("invoice_dt", DateConvertUtil.convertDateToLocalDate(mUnits.getTranxPurOrder().getInvoiceDate()).toString());
    ...
    public JsonObject getOrderSupplierListByProductId(HttpServletRequest request) {
        ...
        for (TranxPurOrderDetailsUnits obj : tranxPurOrderDetailsUnits) {
            if(obj.getTranxPurOrder().getStatus()) {
                ...
                response.addProperty("invoice_date", DateConvertUtil.convertDateToLocalDate(obj.getTranxPurOrder().getInvoiceDate()).toString());
    ...
    public JsonObject purchasePrintOrder(HttpServletRequest request) {
        ...
        try {
            ...
            if (purOrder != null) {
                ...
                invoiceObject.addProperty("invoice_dt", DateConvertUtil.convertDateToLocalDate(purOrder.getInvoiceDate()).toString());
