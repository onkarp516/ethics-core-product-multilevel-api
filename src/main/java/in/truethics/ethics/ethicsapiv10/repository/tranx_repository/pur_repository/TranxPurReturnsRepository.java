...
public interface TranxPurReturnsRepository extends JpaRepository<TranxPurReturnInvoice, Long> {
    ...
    @Query(
            value = "SELECT * FROM `tranx_pur_return_invoice_tbl` WHERE outlet_id=?1 AND branch_id=?2 AND DATE(pur_return_date) BETWEEN ?3 AND ?4 AND status=?5 ORDER by pur_return_date DESC", nativeQuery = true)
    ...
    @Query(
            value = "SELECT * FROM `tranx_pur_return_invoice_tbl` WHERE outlet_id=?1 AND DATE(pur_return_date) BETWEEN ?2 AND ?3 AND status=?4 ORDER by pur_return_date DESC", nativeQuery = true)
    ...
    @Query(
            value = "SELECT * FROM `tranx_pur_return_invoice_tbl` WHERE outlet_id=?1 AND branch_id=?2 AND " +
                    "DATE(pur_return_date) BETWEEN ?3 AND ?4 ORDER by pur_return_date",
            nativeQuery = true)
    ...
    @Query(
            value = "SELECT * FROM `tranx_pur_return_invoice_tbl` WHERE outlet_id=?1 AND " +
                    "DATE(pur_return_date) BETWEEN ?2 AND ?3 AND branch_id IS NULL ORDER by pur_return_date",
            nativeQuery = true)
    ...
    @Query(
            value = "SELECT IFNULL(SUM(total_amount),0.0) FROM " +
                    "`tranx_pur_return_invoice_tbl` WHERE outlet_id=?1 AND branch_id=?2 AND DATE(pur_return_date) " +
    ...
    @Query(
            value = "SELECT IFNULL(SUM(total_amount),0.0) FROM " +
                    "`tranx_pur_return_invoice_tbl` WHERE outlet_id=?1 AND branch_id IS NULL AND DATE(pur_return_date) " +
    ...
    @Query(
            value = "SELECT IFNULL(SUM(total_amount),0.0),IFNULL(SUM(total_base_amount),0.0),IFNULL(SUM(total_tax),0.0),COUNT(*) FROM `tranx_pur_return_invoice_tbl` WHERE sundry_creditors_id=?1 AND DATE(pur_return_date) BETWEEN ?2 AND ?3 AND status=?4", nativeQuery = true)
    List<Object[]> findmobilePurReturnTotalAmt(Long ledgerId, LocalDate startDatep, LocalDate endDatep,boolean b);
    @Query(
            value = "SELECT * FROM `tranx_pur_return_invoice_tbl` WHERE sundry_creditors_id=?1 AND DATE(pur_return_date) BETWEEN ?2 AND ?3 AND status=?4 ORDER by pur_return_date DESC", nativeQuery = true)
