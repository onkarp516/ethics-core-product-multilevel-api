...
public interface TranxCounterSalesRepository extends JpaRepository<TranxCounterSales, Long> {
    ...
    List<TranxCounterSales> findByOutletIdAndBranchIdAndStatusAndTransactionDateAndTransactionStatusAndPaymentModeIgnoreCase(Long id, Long id1, boolean b, LocalDate date, long l, String paymentMode);

    List<TranxCounterSales> findByOutletIdAndStatusAndTransactionDateAndAndTransactionStatusAndPaymentModeIgnoreCaseAndBranchIsNull(Long id, boolean b, LocalDate date, long l, String paymentMode);

    List<TranxCounterSales> findByOutletIdAndBranchIdAndStatusAndTransactionDateAndTransactionStatus(Long id, Long id1, boolean b, LocalDate date, long l);

    List<TranxCounterSales> findByOutletIdAndStatusAndTransactionDateAndAndTransactionStatusAndBranchIsNull(Long id, boolean b, LocalDate date, long l);
