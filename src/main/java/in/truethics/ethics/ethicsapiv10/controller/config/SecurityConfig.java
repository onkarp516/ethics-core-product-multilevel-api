...
public class SecurityConfig extends WebSecurityConfigurerAdapter implements WebMvcConfigurer {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/authenticate", "/api/token/refresh/**",
                "/register_superAdmin","/mobile/authenticate","/mobile/forgetPassword","/mobile/changePassword","/mobile/purchase_list","/mobile/sd_outstandng_list","/mobile/purchase_list","/mobile/payment_list","/mobile/get_dashboard_data","/mobile/get_ledger_tranx_details_report").permitAll();
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setExposedHeaders(ImmutableList.of("Content-Disposition","flname"));
