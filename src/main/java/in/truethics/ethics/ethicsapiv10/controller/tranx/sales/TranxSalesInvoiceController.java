...
//    public ResponseEntity<?> createTranxSalesCompInvoices(HttpServletRequest request) throws Exception {
//        /*
...
//      Api for GSTR1 B2C sales outward data
    ...
    //For pagination
//    @PostMapping(path = "/pg_sales_invoice_list")
//    public Object getSaleInvoiceList(@RequestBody Map<String, String> request,HttpServletRequest req) {
//
//        return service.getSaleInvoiceList(request, req);
//    }
   ...
   /* @PostMapping(path = "/get_sale_invoice_with_ids")
     ...
     *
     drug license expiry or credit days limit exccedes etc
     *******/
...
//        return  service.purchasemobileList(request);
    ...
    public Object listOfCounterSales1(HttpServletRequest req) {
    ...
    @PostMapping(path = "/get_selling_history_list")
    public Object getSellingHistory(HttpServletRequest request) {
        JsonObject result = service.getSellingHistoryList(request);
        return result.toString();
    }

    @PostMapping(path = "/get_non_selling_products_list")
    public Object getNonSellingProducts(HttpServletRequest request) {
        JsonObject result = service.getNonSellingProductsList(request);
        return result.toString();
    }
