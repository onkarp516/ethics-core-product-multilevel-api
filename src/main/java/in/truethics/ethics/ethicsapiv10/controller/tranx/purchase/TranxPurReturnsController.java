...
public class TranxPurReturnsController {
    ...
    @PostMapping(path = "/validate_purchase_return_products")
    public Object validatePurchaseReturnProducts(HttpServletRequest request) throws Exception {
        return service.validatePurchaseReturnProducts(request).toString();
    }

    @PostMapping(path = "/validate_purchase_return_product_batch")
    public Object validatePurchaseReturnProductBatch(HttpServletRequest request) throws Exception {
        return service.validatePurchaseReturnProductBatch(request).toString();
    }

    @PostMapping(path = "/validate_purchase_return_product_quantity")
    public Object validatePurchaseReturnProductQuantity(HttpServletRequest request) throws Exception {
        return service.validatePurchaseReturnProductQuantity(request).toString();
    }
