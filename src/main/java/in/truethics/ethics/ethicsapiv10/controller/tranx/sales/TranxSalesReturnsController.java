...
//        return  service.purchasemobileList(request);
    ...
    @PostMapping(path = "/validate_sale_return_products")
    public Object validatesaleReturnProducts(HttpServletRequest request) throws Exception {
        return service.validatesaleReturnProducts(request).toString();
    }

    @PostMapping(path = "/validate_sales_return_product_batch")
    public Object validateSalesReturnProductBatch(HttpServletRequest request) throws Exception {
        return service.validateSalesReturnProductBatch(request).toString();
    }

    @PostMapping(path = "/validate_sales_return_product_quantity")
    public Object validateSalesReturnProductQuantity(HttpServletRequest request) throws Exception {
        return service.validateSalesReturnProductQuantity(request).toString();
    }
